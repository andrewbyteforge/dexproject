...
from dexproject.paper_trading.intelligence.config.intel_config import INTEL_CONFIGS, IntelLevelConfig
...
try:
    from dexproject.paper_trading.intelligence.dex.dex_price_comparator import DEXPriceComparator as _DEXPriceComparator
