...
from dexproject.paper_trading.intelligence.dex.dex_price_comparator import (
    DEXPriceComparison,
    DEXPrice
)
...
class ArbitrageEngine:
    ...
    def __init__(
        ...
        # Per-chain gas estimates (in gas units)
        # From smart_arbitrage_engine.py
        self.gas_estimates = {
    ...
    def _estimate_gas_cost(self) -> Decimal:
        ...
        Uses per-chain gas estimates for accuracy.
        Assumes 2 swaps (buy + sell) with approval if needed.
        
        Returns:
            Estimated gas cost in USD
        """
        # Get chain-specific gas estimate or use default
