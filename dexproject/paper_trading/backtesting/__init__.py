"""
Backtesting Package - Phase 7B Days 12-13

This package provides backtesting capabilities for all trading strategies:
- Historical data fetching from Yahoo Finance
- Strategy simulation on historical prices
- Performance metrics calculation
- Backtest result visualization

File: dexproject/paper_trading/backtesting/__init__.py
"""
...
from paper_trading.backtesting.simulator import StrategySimulator, SimulatedTrade
